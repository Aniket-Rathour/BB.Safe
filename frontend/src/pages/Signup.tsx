  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen pt-48 px-8 flex flex-col items-center">
      <div className="w-full max-w-md">
        <h1 className="text-5xl font-black mb-12 tracking-tighter">Join<span className="text-indigo-600">.</span></h1>
        <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); navigate('/'); }}>
           <div>
            <label className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 block mb-3">Full Name</label>
            <input type="text" placeholder="Your Name" className="w-full h-14 px-6 rounded-2xl border border-gray-100 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all font-medium" />
          </div>
          <div>
